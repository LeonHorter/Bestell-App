...
**BestellAPP** is a user-friendly web application that allows users to order food online from local restaurants – similar to Lieferando.
...
**01** Clone the repository
   ```bash
   git clone https://github.com/LeonHorter/Bestell-App.git
   ```
...
* **Shopping Cart & Checkout:** Fully functional shopping cart with calculation of shipping costs